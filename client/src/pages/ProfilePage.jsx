...
const ProfilePage = () => {
  ...
  const [name, setName] = useState(authUser.fullName)     //("Johnson Martin")
  const [bio, setBio] = useState(authUser.bio);          //("Hi everyone, I am using EasyChat")
        ...
        <input onChange={(e) => setName(e.target.value)} value={name}
         type='text' required  placeholder='Your name'
          ...
          <textarea onChange={(e) => setBio(e.target.value)} value={bio}
           rows={4} placeholder='Write profile bio' required className='p-2 border 
